...
public class MealsTestUtils {
    ...
    public static final StdProductCreateDTO BUTTER = new StdProductCreateDTO("Maslo", new Nutrition(1, 1, 83));
    public static final StdProductCreateDTO HAM = new StdProductCreateDTO("Szynka", new Nutrition(1.1, 18, 6.2));
